...
### How does opensearch-jvector differ from k-NN?
...
- DiskANN Implementation (Plugin version: 2.19.1.0)
- Incremental Graph Merges (Plugin version: 3.2.0.0)
